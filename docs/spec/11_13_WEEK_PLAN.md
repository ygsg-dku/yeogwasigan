...
| ---: | --- | --- | --- | --- | --- |
| 1 | 요구사항·Task Brief·Pilot 설계 | Purpose 초안, generator, Pilot 6, 인터뷰 질문·가설 | B/D/C | v1 기준 | 두 Purpose와 B3 비교 조건 합의 |
...
| 12 | 결과·인터뷰·발표 | report, 60초 demo, Q&A, evidence package | C/D/A/B | W11 result | 결과/한계/실패 설명 가능 |
| 13 | 최종 재현·리허설 | clean-run guide, final DoD, recording | A/B/C/D | W12 | P0 Evidence 완비, 기능 추가 금지 |

## Gate와 축소 규칙

- Week 2: Purpose package가 B3보다 노출을 줄이는 신호가 없거나 hard Secret이 남으면 차별성 주장을 HOLD하고 P1/P2를 시작하지 않는다.
...
| 10~30초 | INCIDENT_ANALYSIS 패키지와 KEEP/TOKENIZE/DROP | 차별 기능 |
| 30~45초 | T2/T1/T0 policy 결과 | 통제 경계 |
| 45~60초 | B3 대 여과시간 paired result | 공정한 검증 |
